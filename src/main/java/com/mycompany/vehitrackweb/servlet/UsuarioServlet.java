...
public class UsuarioServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (accion) {
            // ==========================================
            // NUEVO: Redirige al formulario de registro
            // ==========================================
            case "nuevo":
            ...
            // ==========================================
            // SECCIÓN LOGIN: Redirige al PANEL tras éxito
            // ==========================================
            case "ingresar":
                ...
                if (u != null) {
                    ...
                    // Si falla, vuelve al index con un aviso
                    response.sendRedirect("index.jsp?error=1");
                }
                break;

            // ==========================================
            // SECCIÓN REGISTRO: Procesa y vuelve al INDEX
            // ==========================================
            case "agregar":
                ...
                dao.agregar(u);
                // Registro exitoso: regresa al index para loguearse
                response.sendRedirect("index.jsp?registro=exitoso");
                break;

            // ==========================================
            // SECCIÓN LISTAR: (Lo que ya funcionaba)
            // ==========================================
            case "listar":
